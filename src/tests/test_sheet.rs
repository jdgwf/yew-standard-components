...
use crate::ui::input_checkbox::InputCheckbox;
use crate::tests::test_sheet_global_vars::PlaceholderToDo;
use crate::ui::nbsp::Nbsp;
use gloo_console::error;
use crate::libs::local_storage_shortcuts::set_local_storage_bool;
use crate::libs::local_storage_shortcuts::set_local_storage_string;
use crate::libs::set_document_title::set_document_title;
use crate::libs::fetch_json::fetch_json;
...
impl Component for TestSheet {
    ...
    fn create(
        ...
        // set_document_title("Test Sheet".to_owned(), "Worksheet".to_owned());
